...
<body>
    ...
    <div class="description">
        ...
        <div class="description-content">
            <p>Monitor your property in real-time with a fully autonomous drone — no cameras, no blind spots, no limits.
            </p>
    ...
    <div class="info-card">
        <div class="info-1-container">
            <div class="info-1_1">
                <h1>100% Autonomous monitoring</h1>
                <p>The SkyGuard system is designed to eliminate the need
                    for expensive and limited fixed camera infrastructure.
                    The drone takes off from a charging station and patrols
                    the environment along a pre-defined route.</p>
            </div>
            <div class="info-1_2">
        ...
        <div class="info-2-container">
            <div class="info-2_1">
                <img src="{{ Vite::asset('resources/images/drone-conecpt.png') }}">
            </div>
            <div class="info-2_2">
                <p>
                    The system features key security tech:
                     a smart, compact computer detects intruders 
                     instantly, while an infrared camera ensures
                      24/7 visibility—even in total darkness.
                </p>
            </div>
        </div>
        <div class="divider"></div>
        <div class="info-3-container">
            <div class="info-3_1">
                The system is designed to function in 
                challenging outdoor environments, helping 
                maintain surveillance coverage throughout changing weather conditions.
            </div>
            <div class="info-3_2">
